        ...
        <div className="max-w-7xl mx-auto pb-8 bg-slate-200 dark:bg-slate-900 lg:px-20">
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid gap-6  mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label htmlFor="serviceProviderShortDsc" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">User Short dsc</label>
                        <input type="text" id="userdsc" name="userdsc" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="User Short dsc" required defaultValue={data?.serviceProviderShortDsc} />
                    </div>
                    <div>
