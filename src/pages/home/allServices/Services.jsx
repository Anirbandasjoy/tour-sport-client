        ...
        <div>
            <div className="max-w-6xl mx-auto pb-10">
                <div className="lg:my-28 my-14 text-center space-y-6 ">
                    ...
                    <h1 className="text-[#061a3a] dark:text-gray-400 lg:text-4xl text-xl sm:text-2xl font-bold ">Our  <span style={{ color: 'red', fontWeight: 'bold' }}>
                        <Typewriter
                            words={['Most Popular Adventures']}
                            loop={loopCount}
                            cursor
                            cursorStyle='❤️'
                            typeSpeed={70}
                ...
                <div className={data.length > 4 ? "text-center" : "hidden"}>
