    ...
    <div className="pb-20">
      ...
      <div className="max-full mt-10 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <p className="mb-3 text-center font-normal text-gray-500 dark:text-gray-400">
          Follow this step-by-step guideline <br /> on how to certify for your
          weekly benefits:
        </p>
      ...
      <div className="details mt-20">
        <div className="flex flex-col  cursor-pointer  bg-white border border-gray-200 rounded-lg shadow md:flex-row  hover:bg-gray-100 relative dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          <img
            className="object-cover w-full flex-1 rounded-t-lg h-96 md:h-auto md:w-60 md:rounded-none md:rounded-l-lg"
            src={serviceImage}
          />
          ...
          <div className="flex flex-1 flex-col justify-between p-4 leading-normal">
            <div>
              ...
              <h1 className="lg:text-xl text-[#ff976a] font-bold text-sm">
                ${servicePrice} <span className="text-gray-500"> / </span>{" "}
              ...
              <div className="flex items-center mb-3 ">
                <div className="flex items-center gap-2">
                  <img
                    ...
                    alt={serviceProviderName}
                  />
                  <h2 className="dark:text-gray-400 text-sm">
                    {serviceProviderName}
                  </h2>
                </div>
              </div>
